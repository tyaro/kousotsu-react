...
const Chart = props => {
  const { data, width: chart_width, height: chart_height ,span} = props;
  ...
  */
  ...
  return (
    ...
    >
      ...
      <text x="5" y={chart_height-5} fill="white" fontSize="10">{span}</text>
      {/* 
      <text x="10" y="16" fill="white" fontSize="16">
        <tspan>$ {lastPrice}</tspan>
        <tspan>
