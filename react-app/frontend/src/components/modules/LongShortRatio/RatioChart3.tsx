import { fetchKlines, fetchTopLongShortPositionRatio } from '../../atomos/FetchBinanceAPI';
...
const RatioChart = (p:{symbol?:string,span:string}) => {
    ...
    const info = fetchTopLongShortPositionRatio({symbol:p.symbol,span:p.span,limit:limit})
